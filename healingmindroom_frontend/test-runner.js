/**
 * Healing Mind Room MVP 비즈니스 로직 및 매칭 알고리즘 검증 러너 (ESM)
 */

import { estimateWaves } from './scratch-bin/utils/waveEstimator.js';
import { matchFarms } from './scratch-bin/utils/matcher.js';
import farms from './src/data/farms.json' with { type: 'json' };
