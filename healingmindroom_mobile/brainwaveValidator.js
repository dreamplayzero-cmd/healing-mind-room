 ...
 *
 * 농촌진흥청 치유농업 연구 기반 뇌파 추정 로직에
 * 입력값 검증 + 연산 안정장치 + 아웃풋 바운딩을 추가한
 * 통합 검증 미들웨어 모듈입니다.
 *
 * 🔬 학술 기준:
 * 농촌진흥청 국책연구 '치유농업 활동의 뇌파 안정도 파라미터 표준 규격'
 * NCBI / HEE 국제 학술지 게재 기준
 * 알파파(8~13Hz 안정) / 세타파(4~8Hz 피로) 기반
 */
