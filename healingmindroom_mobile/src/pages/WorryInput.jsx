...
import VoiceCounsel, { warmUpTTS } from '../components/VoiceCounsel';
...
export default function WorryInput() {
  ...
  const handleSubmit = () => {
    ...
    // 모바일 브라우저(iOS Safari 등)에서 TTS 자동 재생을 허용하기 위한 권한 획득
    warmUpTTS();

    const finalType = selectedType || '기타';
    setWorryInput(finalType, text);
